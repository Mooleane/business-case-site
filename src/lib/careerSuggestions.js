const careerSuggestions = [
  ...
  },
  {
    ...
    category: "Writing, Media & Communication",
    description: "Patience, attention to detail, and a strong sense of narrative or language are essential. Their work involves editing software such as Premiere Pro or text tools like Grammarly, narrative pacing, fact-checking, and quality control.",
    softSkills: ["patience", "attention to detail", "narrative sense"],
    hardSkills: ["Premiere Pro", "Grammarly", "pacing", "fact checking"]
  },
  {
    id: 28,
